...
- 需要极为离谱的 `NODE_VERSION=10.24.1` 才能正确构建；Node.js 10 最早发布于 2018 年，而 10.24.1 是其最后一个版本，发布于 2021 年
...
- 仍在维护
- 强大的 Markdown 扩展功能（高亮块、选项卡……你可以在[小恐龙的独特优势](./migration_notes#%E5%B0%8F%E6%81%90%E9%BE%99%E7%9A%84%E7%8B%AC%E7%89%B9%E4%BC%98%E5%8A%BF)中找到相关描述！）
- 插件功能几乎都是自带的
- 不用写目录
- 美观 (至少它更酷了不是吗 >:)
...
迁移前未对其他框架进行评估。但再次迁移的可能性不大，我们倾向于稳定地保持在同一架构内，减少迁移和学习成本。
