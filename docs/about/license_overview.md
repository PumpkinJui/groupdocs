...
版权归「极筑 · 量筒地图测试群」(2019-2026) 所有。本站内容除另有声明外，均采用 CC-BY-4.0 授权，附加条款亦可能应用。
...
- 通义千问 (Qwen) 对以下内容有所贡献：
  ...
  - 为[面基进度](../meeting_offline)中的表格编写初始 LaTeX 代码  
    该表格现在 Overleaf 托管，同时使用了[照片编辑器](https://github.com/dev-macgyver/PhotoEditor)进行 PDF 转图片操作
