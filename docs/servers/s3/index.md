...
它的前身是生存 II 档服务器，自 2022 年 8 月 7 日开服，在 2022 年 11 月 26 日因病毒攻击而被加密存档，并因没有任何留存的备份而终止了存档支持。生存 II 档服务器一共运行了 111 天，终止存档支持时发展到了生存后期的前期。_**所以一定要记住定期备份！！！**_
...
对生存 II 档感兴趣？你应该看看《[冒险世界：筑梦](../../resources/aw/aw5)》！

## 参数设置

- 生存 II 档和 III 档均使用困难难度，关闭作弊 (意味着死亡掉落)，并可获取成就。  
  _事实上，开生存服的最初目的就是获取成就和消遣娱乐。_
- 生存 III 档的种子为 `5741384467521135721`，初始版本为 1.19。
- 生存 II 档的种子为 `2837720982702917086`，版本为 1.19。
...
<Button text="下载生存服存档（NekoDrive）" url="https://app.nekodrive.net/s/4kDhY" length="large"/>

**备注**：

- 因为存档大小过于庞大，为防止进一步挤占群文件空间，同时为方便备份上传，自 2025 年 3 月 3 日起，我们使用「猫盘（NekoDrive）」进行共享。云盘文件名称中的日期为对应存档的**备份时间**。
