...
装载本包之后，将在您的世界添加三种新实体：交互实体、NPC、适用于国际版的 NPC 。
...
1. [交互实体 - 中文 Minecraft Wiki](https://zh.minecraft.wiki/w/交互实体)
2. [Tutorial:自定义实体 - 中文 Minecraft Wiki](https://zh.minecraft.wiki/w/Tutorial:自定义实体)
3. [创建 NPC - 微软文档](https://learn.microsoft.com/en-us/minecraft/creator/documents/createnpcs?view=minecraft-bedrock-stable)
