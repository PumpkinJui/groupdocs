                ...
                links: [
                    {
                        ...
                        items: [
                            {
                                label: "30 种死法 2",
                                to: "/docs/resources/wstd/wstd2",
                            },
                            {
                                label: "量筒的起床战争",
                                to: "docs/resources/bedwars",
                            },
                            {
                                label: "冒险世界：苏醒",
                                to: "docs/resources/aw/aw2",
                            },
                            {
                                label: "冒险小世界：剑之试炼",
                                to: "docs/resources/aw/aw4",
                            },
                            {
                                label: "冒险世界：筑梦",
                                to: "docs/resources/aw/aw5",
                            },
                            {
                                label: "Minecraft Picross",
                                to: "docs/resources/minecraft_picross",
                            },
                            { label: "触发", to: "docs/resources/trigger" },
                        ],
                    },
                    {
                        title: "常用链接与工具",
                        items: [
                            ...
                            {
                                label: "下载国际基岩版 Minecraft",
                                to: "docs/tools/urls/mcbe",
                            },
                            {
                                label: "MC 开发者常用链接合集",
                                to: "/docs/tools/urls/develop",
                            },
                        ],
                    },
                    {
                        ...
                        items: [
                            ...
                            {
                                label: "许可证概览",
                                to: "/docs/about/license_overview",
                            },
                        ],
                    },
                    {
                        ...
                        items: [
                            ...
                            {
                                label: "群历史",
                                to: "/docs/about/group_history",
                            },
                            {
                                label: "群文档历史",
                                to: "/docs/about/groupdocs_history",
                            },
                            {
                                label: "关于群文档",
                                to: "/docs/about/about_groupdocs",
                            },
                        ],
                    },
                ],
            ...
            "@docusaurus/plugin-client-redirects",
            {
                createRedirects(existingPath) {
                    if (existingPath.includes("/docs/servers/s3")) {
                        return [existingPath.replace("/s3", "/SurvivalIII")];
                    }
                    return undefined;
                },
            },
